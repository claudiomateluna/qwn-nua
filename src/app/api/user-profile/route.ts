...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Check if service role key is available - this is required for user profile creation
    ...
    console.log('Service role key found, proceeding with profile creation for user:', userId);
    ...
    console.log('Attempting to upsert user profile with data:', { ...userProfileData, password: '[HIDDEN]' }); // Don't log sensitive data
