...
export async function generateMetadata(): Promise<Metadata> {
  const { metadata } = await readContentFile('lo-que-hacemos', 'vida-al-aire-libre');
  return {
...
export default async function VidaAlAireLibrePage() {
  const { content, metadata } = await readContentFile('lo-que-hacemos', 'vida-al-aire-libre');
  ...
  return (
    <>
      <MdNavbar currentPage={metadata.title || 'Vida Al Aire Libre'} />
