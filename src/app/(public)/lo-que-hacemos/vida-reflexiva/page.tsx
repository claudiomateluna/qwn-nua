...
export default function VidaReflexivaPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-(--clr1) to-(--clr8) py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-(--clr4) mb-6">VIDA REFLEXIVA</h1>
          <p className="text-xl text-(--clr3)">Profundizando en valores y crecimiento personal</p>
        </div>
        ...
        <div className="bg-(--clr1) rounded-2xl p-12 mb-12 shadow-lg border border-(--clr4)/20 text-center">
          ...
          <p className="text-(--clr3) mb-6">
            Estamos trabajando para traerte la información sobre Vida Reflexiva.
          </p>
