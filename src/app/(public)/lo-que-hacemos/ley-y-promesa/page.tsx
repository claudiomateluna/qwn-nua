...
export default function LeyYPromesaPage() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-(--clr1) to-(--clr8)">
      <div className="flex-grow">
        <div className="container mx-auto px-4 max-w-4xl py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-(--clr4) mb-6">LEY Y PROMESA</h1>
            <p className="text-xl text-(--clr3)">Los principios fundamentales del movimiento scout</p>
          </div>
          ...
          <div className="bg-(--clr1) rounded-2xl p-12 mb-12 shadow-lg border border-(--clr4)/20 text-center">
            ...
            <p className="text-(--clr3) mb-6">
              Estamos trabajando para traerte la información sobre Ley y Promesa.
            </p>
          ...
          <div className="flex justify-between items-center">
            ...
            <Link href="/lo-que-hacemos/programa-y-actividades">
              <Button>
                Siguiente: Programa y Actividades →
              </Button>
            </Link>
          </div>
        </div>
