...
export async function generateMetadata(): Promise<Metadata> {
  const { metadata } = await readContentFile('lo-que-hacemos', 'sistema-de-equipos');
  return {
...
export default async function SistemaDeEquiposPage() {
  const { content, metadata } = await readContentFile('lo-que-hacemos', 'sistema-de-equipos');
  ...
  return (
    <>
      <MdNavbar currentPage={metadata.title || 'Sistema De Equipos'} />
